...
def setup_everything():
    ...
    # parser.add_argument("--train_args_file", type=str, default='train_args/sft/full/llama2-13b-sft-full.json')
    parser.add_argument("--train_args_file", type=str, default='train_args/sft/lora/llama3-8b-sft-lora.json')
    # parser.add_argument("--train_args_file", type=str, default='train_args/sft/qlora/llama2-13b-sft-qlora.json')
